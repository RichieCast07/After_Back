...
import type { SyncTicketPricesHandler } from "./handlers/syncTicketPricesHandler.js";
...
export class MetricsController {
    ...
    private readonly syncTicketPricesHandler: SyncTicketPricesHandler;
    ...
    constructor(
        ...
        syncTicketPricesHandler: SyncTicketPricesHandler
    ) {
        ...
        this.syncTicketPricesHandler = syncTicketPricesHandler;
    }
    ...
    syncTicketPrices(req: Request, res: Response): Promise<void> {
        return this.syncTicketPricesHandler.handle(req, res);
    }
}
